         ...
         <KeyboardAwareScrollView extraHeight={hp('15%')} showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.logintag}>
                <View style={styles.logo_view}>
                    <Image source={require('../assets/icon/Register_logo.png')} resizeMode='contain' style={styles.loginlogo} />
                </View>
                    ...
                    <View style={styles.passwordview}>
                        ...
                        />
                          <TouchableOpacity style={styles.passwordicon}>
                                    <Image source={require('../assets/icon/password_icon.png')} resizeMode="contain" style={{ height: hp('2%'), width: wp('5%'),}}></Image>
                                </TouchableOpacity>
                    </View>
                    <View style={styles.passwordview}>
                        <TextInput style={styles.password_lable_color}
                ...
                <View style={styles.login}>
                    <TouchableOpacity style={styles.login_button_style} onPress={() => { props.navigation.navigate('Followers') }}><Text style={styles.next_text}>Register</Text></TouchableOpacity>
                </View>
                ...
                <View style={styles.noaccount_View}>
                    ...
                    <TouchableOpacity style={styles.regi_view} onPress={() => { props.navigation.navigate('Login')}}>
                        {/* <View > */}
                            <Text style={styles.regi_text}> Login Now</Text>
                        {/* </View> */}
                    </TouchableOpacity>
                </View>
            </View>
