...
import { splash_logo, Left_errow, serch_icon, map_icon, plus_icon, close_icon, plus_circle, group_2, Ellipse_1, user, call_calling, sms, routing, lifebuoy,phone,email } from '../utils/appContest';
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.headre_style}>
                ...
                <TouchableOpacity style={styles.left_errow_view} onPress={() => { props.navigation.navigate('Update_Profile')}} >
                    <Image source={group_2} resizeMode="stretch" style={styles.left_errow_style} />
                </TouchableOpacity>
            </View>
            <View style={{ height: hp('2%'), width: wp('100%') }}></View>
            <View style={{ height: hp('15%'), width: wp('100%'), flexDirection: "row" }}>
                <View style={{ height: hp('13%'), width: wp('35%'), justifyContent: "center" }}>
                    <Image source={Ellipse_1} style={{ height: hp('15%'), width: wp('30%'), resizeMode: "contain", alignSelf: 'center', }}></Image>
                </View>
                <View style={{ height: hp('13%'), width: wp('65%'), justifyContent: "center" }}>
                    ...
                    <View style={{ height: hp('5%'), width: wp('66%'), alignItems: 'center', flexDirection: "row" }}>
                        <View style={{ height: hp('4%'), width: wp('9%'), justifyContent: "center", }}>
